...
const Footer = ({ selectedMenu = '' }) => {
  return (
    <div className='fixed bottom-0 z-50 bg-white flex items-center justify-between w-full max-w-[430px] px-10 py-3 left-1/2 transform -translate-x-1/2 rounded-t-[20px] shadow-[0_-1px_10px_-1px_rgba(0,0,0,0.1)]'>
      <Link to={'/main'}>
